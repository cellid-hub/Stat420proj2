...
MSE1 <-function(mu,variance,n) {
  MSE <- variance/n + (mean(empirical_results[i])-mu)^2
}
...
```{r}
rand_mu <- runif(4,min=70,max=140)
mse <- c()
mse <- append(mse,MSE1(rand_mu[1],4,8))
mse <- append(mse,MSE2(rand_mu[2],4,8))
mse <- append(mse,MSE3(rand_mu[3],4,8))
mse <- append(mse,MSE4(rand_mu[4],4,8))
...
```{r}
rand_mu <- runif(4,min=70,max=140)
rand_n <- runif(4,min=0,max=200)
mse <- c()

mse <- append(mse,MSE1(rand_mu[1],4,rand_n[i]))
mse <- append(mse,MSE2(rand_mu[2],4,rand_n[i]))
mse <- append(mse,MSE3(rand_mu[3],4,rand_n[i]))
mse <- append(mse,MSE4(rand_mu[4],4,rand_n[i]))
